...
open class MainTabBar: UITabBar {
    ...
    private var buttons: [MainTabBarButton] = []
    ...
    open override var tintColor: UIColor! {
        didSet {
            buttons.forEach { button in
                if (button.item as? MainTabBarItem)?.tintColor == nil {
    ...
    private func button(forItem item: UITabBarItem) -> MainTabBarButton {
        let button = MainTabBarButton(item: item)
    ...
    @objc private func btnPressed(sender: MainTabBarButton) {
