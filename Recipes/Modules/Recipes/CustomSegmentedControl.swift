...
public protocol CustomSegmentedControlDelegate: class {
...
open class CustomSegmentedControl: UIControl {
    ...
    open weak var delegate: CustomSegmentedControlDelegate?
    ...
    open var font: UIFont = UIFont.systemFont(ofSize: 14, weight: UIFont.Weight.medium) {
        didSet {
